...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheAssetsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheAssetsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheAssetsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheAssetsListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheAssetsListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheAssetsListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheAssetsListGenerated.onTable(defaultTableId).iPressRow(0);
