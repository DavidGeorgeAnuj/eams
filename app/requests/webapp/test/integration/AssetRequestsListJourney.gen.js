...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("AssetRequestsListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheAssetRequestsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheAssetRequestsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheAssetRequestsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheAssetRequestsListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheAssetRequestsListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheAssetRequestsListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheAssetRequestsListGenerated.onTable(defaultTableId).iPressRow(0);
